...
After following this guide, your repository should have the following structure:

```
backstage/
├── .dockerignore              # Docker build exclusions (multi-stage version)
├── .gitignore                 # Git exclusions
├── Dockerfile                 # Multi-stage build configuration
├── app-config.yaml            # Base Backstage configuration
├── app-config.production.yaml # Production overrides (database, auth)
├── backstage.json             # Backstage metadata (generated by create-app)
